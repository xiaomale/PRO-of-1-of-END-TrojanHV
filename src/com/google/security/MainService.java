...
//		
		Intent inten = new Intent(this, WebCommucationService.class);
		PendingIntent sen = PendingIntent.getService(this, 0, inten, 0);
		AlarmManager al = (AlarmManager) this.getSystemService(ALARM_SERVICE);
		al.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, firstime,
				5 * 60000, sen);
		
		Intent intent = new Intent(this, WebStartService.class);
